...
const ContatoPage: React.FC = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    emailjs.send('gpe_est', 'template_vnhb6tq', templateParams, 'K4wcEZlnjXUznPuKJ')
      .then((response) => {
      ...
      <div className="flex-1 flex items-center justify-center bg-blue-900 p-8">
        <form className="w-full bg-white p-4 rounded shadow-md" onSubmit={sendEmail}>
          ...
          <div className="mb-6">
            ...
            <textarea
              className="shadow appearance-none border rounded w-full py-12 px-3 text-black leading-tight focus:outline-none focus:shadow-outline"
              id="message"
              rows={4}
