...
const ArtigosPage: React.FC = () => {
    return (
        <div className="flex flex-col items-center justify-center px-6 text-center text-black min-h-screen">
            <div className="mt-8  max-w-4xl mx-auto text-left">
                <h2 className="text-xl font-bold mb-2 text-blue-900 hover:text-blue-500 transition duration-300 cursor-default">SOBRE DIVULGAÇÃO DE PESQUISAS ELEITORAIS</h2>
                <p className="mb-4">
                    Em 1985, Fernando Henrique Cardoso-FHC, que depois veio a se tornar presidente por
                    dois mandatos do país, se sentou na cadeira de prefeito da cidade de São Paulo, atendendo pedido de jornalisitas.
                    O dia era 14 de novembro, véspera da eleição. Perdeu. Nunca se saberá se perdeu para Jânio Quadros, ex-presidente, por essa razão.
                    Contudo, ficou a imagem de que esse sentar-se, a rigor, posar na cadeira para fotografia, ou, para ser mais preciso, esse gesto, uma
                ...
                <p className="mb-4">
                    <strong>Obviamente, quando se fala em divulgar, em período eleitoral, está pressuposto o devido registro na Justiça Eleitoral.  Não há espaço legal para divulgação sem estar de acordo com a Lei e suas exigências.
                    </strong>
                </p>
                <p className="mb-4">
