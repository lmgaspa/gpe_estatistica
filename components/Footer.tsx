  ...
  return (
    <footer className="bg-blue-900 p-6 text-white">
      <div className="container mx-auto flex flex-col items-center justify-center text-center">
        <p className='hover:text-yellow-300 cursor-pointer'>&copy; {new Date().getFullYear()} GPE Estatística. Todos os direitos reservados.</p>
        <div className="flex flex-col sm:flex-row mt-4 space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <a href="https://wa.me/5571991474445" className="flex items-center space-x-2 hover:text-yellow-300" target="_blank" rel="noopener noreferrer">
            <FaWhatsapp />
