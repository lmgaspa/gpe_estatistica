  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center text-black min-h-screen">
      ...
      <div className="mt-8  max-w-4xl mx-auto text-left">
        <h2 className="text-xl font-bold mb-2">Nota de Esclarecimento - Ibicoara</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-bold mb-2 mt-8">Nota de Esclarecimento - Pesquisa em Guaratinga</h2>
        <p className="mb-4">
