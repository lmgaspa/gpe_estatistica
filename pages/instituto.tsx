    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full bg-white rounded-lg shadow-md text-center">
        ...
        <div className="mt-4">
          ...
          <h2 className="list-disc list-inside text-left mx-auto w-3/4 text-xl font-semibold mt-6">Sobre a empresa</h2>
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Quem somos?</h3>
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4 pb-2">Missão</h3>
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4 pb-2">Política da GPE</h3>
          <p className="text-justify mx-auto w-3/4">
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Potencial de mercado</h3>
          <ul className="list-disc list-inside text-left mx-auto w-3/4 mt-2">
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Avaliação de gestões e de serviços ao público</h3>
          <ul className="list-disc list-inside text-left mx-auto w-3/4 mt-2">
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Utilização dos meios de comunicação</h3>
          <ul className="list-disc list-inside text-left mx-auto w-3/4 mt-2">
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Avaliação da marca, produto e serviço</h3>
          <ul className="list-disc list-inside text-left mx-auto w-3/4 mt-2">
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Pesquisas customizadas</h3>
          <ul className="list-disc list-inside text-left mx-auto w-3/4 mt-2">
          ...
          <h3 className="list-disc list-inside text-left mx-auto w-3/4 text-lg font-semibold mt-4">Pesquisas qualitativas</h3>
          <ul className="list-disc list-inside text-left mx-auto w-3/4 mt-2">
          ...
          <h2 className="list-disc list-inside text-left mx-auto w-3/4 text-xl font-semibold mt-6 pb-2">Histórico</h2>
          <p className="text-justify mx-auto w-3/4">
          ...
          <h2 className="list-disc list-inside text-left mx-auto w-3/4 text-xl font-semibold mt-6 pb-2">Instituto associado</h2>
          <p className="text-justify mx-auto w-3/4">
